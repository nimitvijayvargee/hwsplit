            ...
            [_BASE] =
                {
                    ...
                    {KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, XXXXXXX, XXXXXXX},
                    {XXXXXXX, XXXXXXX, KC_LCTL, KC_SPC, KC_LALT, KC_LGUI, XXXXXXX, XXXXXXX, KC_RGUI, KC_RALT, MO(_FN), KC_RCTL, XXXXXXX, XXXXXXX}},
